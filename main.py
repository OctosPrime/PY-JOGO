#Grupo Trabalho:
# Kayky Dias Ulkovski - RGM: 802.541
# Eduardo Lacerda dos Santoos - RGM: 802.523
# Davyson do Amaral Bitencourt - RGM: 802.590
# Hugo Araujo Teixeira - RGM: 802.464
...
pygame.display.set_caption("Quadradinho Aventureiro")
...
#Configuração de Fontes e Relógio (FPS)
...
def adicionar_inimigo():
    ...
    #Definir uma velocidade aleatória entre positiva ou negativa para x e y
    vx = random.choice([-5, -4, 4, 5])
    vy = random.choice([-5, -4, 4, 5])
    
    #Adicionar as propriedades do inimigo na lista
...
def resetar_jogo():
    ...
    pontuacao = 0
    fim_de_jogo = False
    tempo_aviso = 0 #Temporizador do texto de "Novo Inimigo!"
